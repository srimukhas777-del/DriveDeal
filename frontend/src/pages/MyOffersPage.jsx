            ...
            <div className="container mx-auto px-4 max-w-6xl">
                ...
                {offers.length === 0 ? (
                    <div className="bg-white rounded-xl shadow-lg p-12 text-center">
                        ...
                        <p className="text-gray-600 text-lg mb-6">You haven't made any offers</p>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        {offers.map((offer) => {
                            // Safety check for deleted cars
                            if (!offer.car) {
                                return (
                                    <div key={offer._id} className="bg-white rounded-xl shadow-md p-6 border border-gray-100">
                                        <div className="text-red-500 font-bold mb-2">Car Unavailable</div>
                                        <p className="text-gray-500 text-sm">This car may have been removed.</p>
